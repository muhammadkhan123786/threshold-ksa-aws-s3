...
export const useValidationSchemas = (stepKey: string) => {
    ...
    const fileInformationSchema = yup.object().shape({
        ...
        sportType: yup
            ...
            .test(
                'is-valid-sportType',
                trans('validation.club-admin.updatePersonalInfo.sportTypeRequired'),
                (value) =>
                    (typeof value === 'string' && value.trim() !== '') || // Valid string
                    (typeof value === 'object' &&
                        value !== null &&
        ...
        contractDuration: yup
            .mixed<any>()
            .required(trans('validation.club-admin.updatePersonalInfo.contractDurationRequired'))
            .test(
                'is-valid-contractDuration',
                trans('validation.club-admin.updatePersonalInfo.contractDurationRequired'),
                (value) =>
