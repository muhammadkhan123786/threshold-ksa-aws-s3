...
export const ClothesMissingWrapper = styled.div`
    display: flex;
`;
export const SessionsStatusDiv = styled.div`
    display: flex;
    flex-direction: column;
`;
...
export const IconEmptyData = styled.img`
    height: 16px;
    width: 16px;
    margin: 5px;
`;
...
export const ButtonIcon = styled.img`
    ...
    margin: 5px;
`;
export const SpanCatygoryMale = styled.span`
    ...
    font-weight: 600;
`;
export const SpanCatygoryFemale = styled.span`
