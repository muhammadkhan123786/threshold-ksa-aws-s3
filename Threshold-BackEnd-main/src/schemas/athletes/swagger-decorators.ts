...
export function SwaggerCreateClothingData() {
    return applyDecorators(
        ApiOperation({ summary: "Create clothing data for an athlete" }),
        ApiParam({
            name: "id",
        ...
        ApiBody({
            ...
            examples: {
                example1: {
                    summary: "Standard athlete clothing data",
                    value: {
                        tShirtSize: "m",
                        pantSize: "l",
                        shoeSize: "42",
        ...
        ApiResponse({
            status: 409,
            description: "Clothing data already exists for this athlete",
        })
    );
}
...
export function SwaggerUpdateClothingData() {
    return applyDecorators(
        ...
        ApiBody({
            ...
            examples: {
                example1: {
                    summary: "Updated athlete clothing data",
                    value: {
                        tShirtSize: "l",
                        pantSize: "xl",
                        shoeSize: "43",
